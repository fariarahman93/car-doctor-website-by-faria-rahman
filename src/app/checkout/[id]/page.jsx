// "use client";
// import { getServicesDetail } from "@/services/getServices"; // Corrected function import
...
//   const { data } = useSession(); // Destructure session data
//   const [service, setService] = useState({});

//   // Fetch service details by ID
//   const loadService = async () => {
//     try {
//       const details = await getServicesDetail(params.id); // Correct function call
...
//     try {
//       const resp = await fetch('http://localhost:3000/checkout/api/new-booking', { // Corrected URL
//         method: 'POST',
...
const Checkout = ({ params }) => {
  ...
  const [service, setService] = useState({});
  const { incrementCart } = useCart(); // Use the context to manage cart
